            ...
            <div>
                <Grid>
                    ...
                    <Grid>
                        ...
                        {main.map((data)=>(
                            <Grid>
                                <Grid style={{backgroundColor:' #26253d'}}>
                                    ...
                                    <Grid md={4} xs={8} >
                                      {data.investment.map((req)=>(
                                          <Grid style={{backgroundColor:'black'}}>
                                              <Grid >
                                              <Button color='primary' style={{}} onClick={(user)=>{confirm(data.username,req.key,req.amount)}}>
                                                <p style={{textAlign:'center',marginLeft:-30,padding:0,marginRight:-30,color:'white'}}>
                                                    Confirm
                                                </p>
