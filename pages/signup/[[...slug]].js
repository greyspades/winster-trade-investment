  ...
  return (
   <div style={{display:"grid",placeItems:"center"}}>
    ...
    <Card style={{
        ...
        <Formik initialValues={{name:'',email:'',password:'',nextPassword:'',username:'',}} onSubmit={(values)=>{
                  let user={
                    name:values.name,
                    email:values.email,
                  ...
                  if(values.password==values.nextPassword&&values.password.length>=8 &&values.name&&values.email&&values.username){
                    // setUser({
                    // name:values.name,
                    // email:values.email,
                    // password:values.password,
